...
import hero from "@/assets/الطبيعه الجبليه.png";
  ...
  return (
    <div dir="rtl" className="relative min-h-screen w-full overflow-hidden text-white">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(0,61,43,0.60) 0%, rgba(0,87,63,0.30) 48%, rgba(0,45,32,0.56) 100%)",
        }}
      />
      <div
        className="absolute inset-0"
        style={{ background: "radial-gradient(ellipse at center, rgba(0,0,0,0) 52%, rgba(0,20,14,0.30) 100%)" }}
      />
