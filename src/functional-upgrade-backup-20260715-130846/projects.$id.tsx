  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
      <Card className="lg:col-span-2 overflow-hidden">
        <CardHeader title="نسبة تقدم المشروع" subtitle="التقدم التراكمي خلال آخر 6 أشهر" action={<span className="rounded-full bg-primary/10 px-3 py-1 text-[11px] font-semibold text-primary">محدث اليوم</span>} />
