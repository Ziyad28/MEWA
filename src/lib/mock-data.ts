...
export const COMPANIES: Company[] = [
  ...
  { id: 7, name: "شركة ثقة لخدمات الأعمال", nameEn: "Thiqa", domain: "thiqa.sa", description: "حلول ذكية وشراكات استراتيجية لقطاع الأعمال.", regNo: "1010321456", address: "الرياض - الرائدة المدينة الرقمية", email: "partners@thiqa.sa", phone: "+966 11 400 1111", website: "thiqa.sa", contactPerson: "أ. سعد اليحيى", contactRole: "مدير الشراكات", sector: "البيئة", status: "نشط", performance: 95, commitment: 98, since: "2023/10/01", contractNo: "MEWA-2023-088", contractStart: "2023/10/01", contractEnd: "2027/10/01", lastUpdate: "2026/01/15", perfHistory: PH(95) },
  { id: 8, name: "شركة مايكروسوفت (Microsoft)", nameEn: "Microsoft", domain: "microsoft.com", description: "شريك تقني وبناء قدرات في الذكاء الاصطناعي السحابي.", regNo: "1010112233", address: "الرياض - واجهة الرياض", email: "gov-sa@microsoft.com", phone: "+966 11 200 9999", website: "microsoft.com", contactPerson: "م. أحمد الدوسري", contactRole: "المدير الإقليمي للقطاع الحكومي", sector: "المياه", status: "نشط", performance: 92, commitment: 90, since: "2024/01/15", contractNo: "MEWA-2024-001", contractStart: "2024/01/15", contractEnd: "2029/01/14", lastUpdate: "2026/05/10", perfHistory: PH(92) },
  { id: 9, name: "شركة سيسكو (Cisco)", nameEn: "Cisco", domain: "cisco.com", description: "مستشار استراتيجي لبنية الشبكات والأمن السيبراني.", regNo: "1010445566", address: "الرياض - أبراج العليا", email: "saudi-gov@cisco.com", phone: "+966 11 555 4444", website: "cisco.com", contactPerson: "م. طارق عبدالله", contactRole: "مهندس استشاري", sector: "الزراعة", status: "نشط", performance: 88, commitment: 85, since: "2022/05/20", contractNo: "MEWA-2022-040", contractStart: "2022/05/20", contractEnd: "2025/05/19", lastUpdate: "2026/03/01", perfHistory: PH(88) },
  { id: 10, name: "شركة أوراكل (Oracle)", nameEn: "Oracle", domain: "oracle.com", description: "مزود استراتيجي لقواعد البيانات والأنظمة السحابية.", regNo: "1010778899", address: "الرياض - برج الفيصلية", email: "saudi-public@oracle.com", phone: "+966 11 666 7777", website: "oracle.com", contactPerson: "أ. منال السعيد", contactRole: "مديرة علاقات العملاء", sector: "البيئة", status: "قيد المراجعة", performance: 80, commitment: 82, since: "2025/02/10", contractNo: "MEWA-2025-012", contractStart: "2025/02/10", contractEnd: "2028/02/09", lastUpdate: "2026/06/05", perfHistory: PH(80) },
];
...
export const COMPANY_PROFILES: Record<number, { overview: string; history: string; specialties: string[] }> = {
  ...
  7: { overview: "شريك استراتيجي يقدم حلول ذكية ومتكاملة لدعم قطاع الأعمال وتبسيط الإجراءات التشغيلية والتنظيمية.", history: "تمتد الشراكة الاستراتيجية مع الوكالة لتقديم ورش عمل متخصصة وتبادل الخبرات دون الارتباط المباشر بمشروع تقني محدد حالياً.", specialties: ["تطوير الأعمال", "الحلول الذكية", "الاستشارات"] },
  8: { overview: "عملاق التقنية العالمي، يعتبر شريك استراتيجي في مبادرات بناء القدرات وتبني الذكاء الاصطناعي والحوسبة السحابية.", history: "مذكرة تفاهم وشراكة استراتيجية تهدف لتطوير الكوادر التقنية في الوكالة، وتوفير ورش عمل تقنية متقدمة في مجالات الذكاء الاصطناعي.", specialties: ["الذكاء الاصطناعي", "الحوسبة السحابية", "بناء القدرات"] },
  9: { overview: "شريك تقني عالمي رائد في توفير حلول الشبكات المتطورة والبنية التحتية للاتصالات والأمن السيبراني.", history: "شراكة استراتيجية مستمرة لتقييم بنية الشبكات الحالية للوكالة وتقديم استشارات فنية متقدمة لبناء الجيل القادم من الشبكات.", specialties: ["بنية الشبكات", "الأمن السيبراني", "الاستشارات الفنية"] },
  10: { overview: "مزود عالمي رائد في مجال قواعد البيانات المتقدمة وأنظمة تخطيط الموارد المؤسسية السحابية.", history: "ترتبط الشركة مع الوكالة باتفاقية إطارية لتقديم الدعم الفني وتراخيص قواعد البيانات وورش نقل المعرفة للمهندسين.", specialties: ["قواعد البيانات", "الأنظمة المؤسسية", "السحابة المدمجة"] },
};

export const PROJECTS: Project[] = [
  { id: 1, name: "مشروع التحول الرقمي", sector: "البيئة", manager: "فهد المطيري", status: "قيد التنفيذ", priority: "عالية", progress: 66, plannedProgress: 70, updated: "2026/07/15", start: "2026/01/01", end: "2026/12/31", description: "رقمنة الخدمات البيئية الداخلية وأتمتة سير العمل.", spark: [30,42,50,55,60,66], departmentId: "dt", subDepartmentId: "dt_eservices" },
  { id: 2, name: "مشروع الأمن السيبراني", sector: "البيئة", manager: "خالد الشهري", status: "قيد التنفيذ", priority: "عالية", progress: 45, plannedProgress: 50, updated: "2026/07/14", start: "2026/02/10", end: "2026/11/30", companyId: 5, description: "تعزيز حماية الأنظمة الحساسة وبناء مركز عمليات الأمن.", spark: [10,18,25,32,38,45], departmentId: "dt", subDepartmentId: "dt_emerging" },
  { id: 3, name: "مشروع البنية التحتية", sector: "المياه", manager: "خالد الشهري", status: "قيد التنفيذ", priority: "متوسطة", progress: 80, plannedProgress: 75, updated: "2026/07/13", start: "2025/09/01", end: "2026/09/30", companyId: 4, description: "تحديث مراكز البيانات الإقليمية وشبكات الاتصال.", spark: [40,50,58,68,74,80], departmentId: "infra", subDepartmentId: "infra_network" },
  { id: 4, name: "مشروع الخدمات الذكية", sector: "الزراعة", manager: "خالد الشهري", status: "قيد التنفيذ", priority: "متوسطة", progress: 30, plannedProgress: 35, updated: "2026/07/12", start: "2026/03/01", end: "2027/02/28", description: "منصة خدمات ذاتية للمزارعين والمستفيدين.", spark: [5,10,14,20,25,30], departmentId: "dt", subDepartmentId: "dt_eservices" },
  { id: 5, name: "منصة رصد المياه", sector: "المياه", manager: "سعد الغامدي", status: "مكتملة", priority: "عالية", progress: 100, plannedProgress: 100, updated: "2026/05/20", start: "2025/01/15", end: "2026/05/10", companyId: 1, description: "منصة موحّدة لرصد جودة ومستوى المياه على مستوى المملكة.", spark: [60,70,80,90,96,100], departmentId: "app", subDepartmentId: "app_solutions" },
  { id: 6, name: "نظام الرصد البيئي", sector: "البيئة", manager: "نورة العتيبي", status: "قيد التنفيذ", priority: "متوسطة", progress: 58, plannedProgress: 65, updated: "2026/07/10", start: "2025/11/01", end: "2026/12/01", companyId: 2, description: "أجهزة استشعار وذكاء اصطناعي لرصد جودة الهواء والتربة.", spark: [15,25,34,42,50,58], departmentId: "app", subDepartmentId: "app_bi" },
  { id: 7, name: "منصة الزراعة الذكية", sector: "الزراعة", manager: "فيصل القحطاني", status: "متأخرة", priority: "عالية", progress: 35, plannedProgress: 60, updated: "2026/07/08", start: "2025/06/01", end: "2026/06/30", companyId: 3, description: "منظومة IoT لري ذكي وإدارة المحاصيل.", spark: [20,28,30,32,34,35], departmentId: "dt", subDepartmentId: "dt_enterprise" },
  { id: 8, name: "مشروع أتمتة التراخيص", sector: "الزراعة", manager: "فهد المطيري", status: "قيد التنفيذ", priority: "متوسطة", progress: 52, plannedProgress: 55, updated: "2026/07/09", start: "2026/01/20", end: "2026/12/15", companyId: 6, description: "أتمتة إصدار وتجديد التراخيص الزراعية.", spark: [12,20,28,38,46,52], departmentId: "app", subDepartmentId: "app_products" },
  { id: 9, name: "مشروع الأرشفة الإلكترونية", sector: "البيئة", manager: "نورة العتيبي", status: "قيد التنفيذ", priority: "منخفضة", progress: 72, plannedProgress: 75, updated: "2026/07/07", start: "2025/08/01", end: "2026/10/30", companyId: 2, description: "أرشفة موحّدة للوثائق التنظيمية والفنية.", spark: [30,42,55,62,68,72], departmentId: "infra", subDepartmentId: "infra_db" },
  { id: 10, name: "منصة الشراكات الحكومية", sector: "المياه", manager: "سعد الغامدي", status: "مخططة", priority: "متوسطة", progress: 8, plannedProgress: 10, updated: "2026/07/05", start: "2026/08/01", end: "2027/07/30", description: "بوابة موحّدة للشراكات مع الجهات الحكومية.", spark: [0,2,4,5,7,8], departmentId: "dt" },
];
