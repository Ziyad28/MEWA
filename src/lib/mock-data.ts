...
export const PROJECTS: Project[] = [
  { id: 1, name: "مشروع التحول الرقمي", sector: "البيئة", manager: "فهد المطيري", status: "قيد التنفيذ", priority: "عالية", progress: 66, plannedProgress: 70, updated: "2026/07/15", start: "2026/01/01", end: "2026/12/31", health: 78, delayRisk: 22, description: "رقمنة الخدمات البيئية الداخلية وأتمتة سير العمل.", spark: [30,42,50,55,60,66], departmentId: "dt", subDepartmentId: "dt_eservices" },
  { id: 2, name: "مشروع الأمن السيبراني", sector: "البيئة", manager: "خالد الشهري", status: "قيد التنفيذ", priority: "عالية", progress: 45, plannedProgress: 50, updated: "2026/07/14", start: "2026/02/10", end: "2026/11/30", companyId: 5, health: 62, delayRisk: 41, description: "تعزيز حماية الأنظمة الحساسة وبناء مركز عمليات الأمن.", spark: [10,18,25,32,38,45], departmentId: "dt", subDepartmentId: "dt_emerging" },
  { id: 3, name: "مشروع البنية التحتية", sector: "المياه", manager: "خالد الشهري", status: "قيد التنفيذ", priority: "متوسطة", progress: 80, plannedProgress: 75, updated: "2026/07/13", start: "2025/09/01", end: "2026/09/30", companyId: 4, health: 85, delayRisk: 15, description: "تحديث مراكز البيانات الإقليمية وشبكات الاتصال.", spark: [40,50,58,68,74,80], departmentId: "infra", subDepartmentId: "infra_network" },
  { id: 4, name: "مشروع الخدمات الذكية", sector: "الزراعة", manager: "خالد الشهري", status: "قيد التنفيذ", priority: "متوسطة", progress: 30, plannedProgress: 35, updated: "2026/07/12", start: "2026/03/01", end: "2027/02/28", health: 55, delayRisk: 48, description: "منصة خدمات ذاتية للمزارعين والمستفيدين.", spark: [5,10,14,20,25,30], departmentId: "dt", subDepartmentId: "dt_eservices" },
  { id: 5, name: "منصة رصد المياه", sector: "المياه", manager: "سعد الغامدي", status: "مكتملة", priority: "عالية", progress: 100, plannedProgress: 100, updated: "2026/05/20", start: "2025/01/15", end: "2026/05/10", companyId: 1, health: 96, delayRisk: 4, description: "منصة موحّدة لرصد جودة ومستوى المياه على مستوى المملكة.", spark: [60,70,80,90,96,100], departmentId: "app", subDepartmentId: "app_solutions" },
  { id: 6, name: "نظام الرصد البيئي", sector: "البيئة", manager: "نورة العتيبي", status: "قيد التنفيذ", priority: "متوسطة", progress: 58, plannedProgress: 65, updated: "2026/07/10", start: "2025/11/01", end: "2026/12/01", companyId: 2, health: 70, delayRisk: 30, description: "أجهزة استشعار وذكاء اصطناعي لرصد جودة الهواء والتربة.", spark: [15,25,34,42,50,58], departmentId: "app", subDepartmentId: "app_bi" },
  { id: 7, name: "منصة الزراعة الذكية", sector: "الزراعة", manager: "فيصل القحطاني", status: "متأخرة", priority: "عالية", progress: 35, plannedProgress: 60, updated: "2026/07/08", start: "2025/06/01", end: "2026/06/30", companyId: 3, health: 40, delayRisk: 72, description: "منظومة IoT لري ذكي وإدارة المحاصيل.", spark: [20,28,30,32,34,35], departmentId: "dt", subDepartmentId: "dt_enterprise" },
  { id: 8, name: "مشروع أتمتة التراخيص", sector: "الزراعة", manager: "فهد المطيري", status: "قيد التنفيذ", priority: "متوسطة", progress: 52, plannedProgress: 55, updated: "2026/07/09", start: "2026/01/20", end: "2026/12/15", companyId: 6, health: 74, delayRisk: 26, description: "أتمتة إصدار وتجديد التراخيص الزراعية.", spark: [12,20,28,38,46,52], departmentId: "app", subDepartmentId: "app_products" },
  { id: 9, name: "مشروع الأرشفة الإلكترونية", sector: "البيئة", manager: "نورة العتيبي", status: "قيد التنفيذ", priority: "منخفضة", progress: 72, plannedProgress: 75, updated: "2026/07/07", start: "2025/08/01", end: "2026/10/30", companyId: 2, health: 82, delayRisk: 18, description: "أرشفة موحّدة للوثائق التنظيمية والفنية.", spark: [30,42,55,62,68,72], departmentId: "infra", subDepartmentId: "infra_db" },
  { id: 10, name: "منصة الشراكات الحكومية", sector: "المياه", manager: "سعد الغامدي", status: "مخططة", priority: "متوسطة", progress: 8, plannedProgress: 10, updated: "2026/07/05", start: "2026/08/01", end: "2027/07/30", health: 60, delayRisk: 20, description: "بوابة موحّدة للشراكات مع الجهات الحكومية.", spark: [0,2,4,5,7,8], departmentId: "dt" },
];
